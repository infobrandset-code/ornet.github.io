...
import { Zap, Factory, Flame, Pickaxe, Train, FlaskConical, Network, Leaf } from 'lucide-react';
...
export default function Industries() {
  ...
  return (
    <section ref={ref} id="industries" className="py-24 sm:py-32 lg:py-40 bg-[#0A0B0B] border-t border-[#232727] relative overflow-hidden">
      {/* Background Ambience */}
        ...
        <div className="mt-16 sm:mt-24 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          {INDUSTRIES.map((industry, idx) => {
            ...
            return (
              ...
              >
                <ElectroBorder
                  className="bg-[#121414]/60 p-8 sm:p-10 flex flex-col items-center justify-center text-center aspect-square sm:aspect-auto sm:h-[240px] group transition-all duration-500 hover:bg-[#151818]"
                  borderColor="#9FE870"
                  borderWidth={1}
                  radius="16px"
                  animationSpeed={0.6}
                ...
                >
                  ...
                  {/* Industry Label */}
                  <h4 className="text-sm sm:text-base font-semibold text-white tracking-wide uppercase font-mono">
                    {industry.name}
                  </h4>
                </ElectroBorder>
              </div>
